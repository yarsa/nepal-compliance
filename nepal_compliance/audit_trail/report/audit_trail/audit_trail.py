...
from nepal_compliance.audit_trail.report.audit_trail_nepal.utils import get_audit_trail_doctypes
...
class DetailedReport(BaseAuditTrail):
    ...
    def get_fields(self, doctype):
        ...
        elif doctype in DoctypeFields["grand_total_field_doctypes"]:
            fields.append("grand_total as amount")

        elif doctype in DoctypeFields["total_amount_field_doctypes"]:
            fields.append("total_amount as amount")

        if doctype in DoctypeFields["supplier_name_field_doctypes"]:
            fields.append("supplier_name as party_name")

        elif doctype in DoctypeFields["customer_name_field_doctypes"]:
        ...
        elif doctype in DoctypeFields["remarks_field_doctypes"]:
    ...
    def append_rows(self, records, doctype):
        for row in records:
            ...
            if doctype in DoctypeFields["no_name_field_doctypes"]:
                row["party_name"] = ""
                row["amount"] = ""

            elif doctype in DoctypeFields["supplier_name_field_doctypes"]:
