...
def generate_ird_purchase_register_excel():
    ...
    ws["A3"] = f"खरिद फिर्ता खाता,  करदाता दर्ता नं (PAN): {pan}"
    ...
    sub_headers = [
        ...
        "खरिद/पैठारी फिर्ता गरिएका वस्तु वा सेवाको विवरण", "परिमाण", "एकाई",
    ...
    for col_num, header in enumerate(sub_headers, 1):
        if col_num in merged_columns_to_skip_in_subheader:
            continue
